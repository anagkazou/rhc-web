...
function Bullet({ children }: { children: string }) {
  return (
    <li className="flex items-center gap-[18px]">
      <span className="block size-3 rounded-full bg-gradient-to-b from-[#ffed50] to-[#b97e22]" />
      <span className="text-[16px] font-medium text-text-soft tracking-[-0.03em]">
        {children}
      </span>
    </li>
  );
        ...
        <div className="grid w-full gap-4 lg:grid-cols-2">
            ...
            <div className="flex flex-col gap-10 sm:gap-14">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col gap-4 border-b border-divider pb-6">
                  ...
                  <p className="max-w-[380px] text-[15px] sm:text-[16px] leading-6 text-body tracking-[-0.04em]">
                    Curated access to the deepest offers in the market,
              ...
              <OpenVipModalButton
                className="gold-cta inline-flex h-12 w-full max-w-[212px] items-center justify-center whitespace-nowrap rounded-[8px] px-8 text-[16px] font-medium uppercase tracking-[-0.04em]"
              >
                Become a VIP
              </OpenVipModalButton>
            </div>
          ...
          >
            <div className="flex flex-col gap-10 sm:gap-14">
              ...
              <a
                href="#contact"
                className="btn-chamfer inline-flex h-12 w-full max-w-[212px] items-center justify-center whitespace-nowrap px-8 text-[16px] uppercase tracking-[-0.04em] text-text-warm"
              >
                Become a Partner
              </a>
            </div>
